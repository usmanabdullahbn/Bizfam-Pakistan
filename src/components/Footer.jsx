        ...
        <div className="container">
          <div className={styles.ctaInner}>
            ...
            <div className={styles.ctaBtns}>
              <Link to="/contact" className={styles.ctaBtnPrimary}>Get a Free Quote</Link>
              <Link to="/products" className={styles.ctaBtnOutline}>View Products</Link>
            </div>
          </div>
        </div>
      </div>
        ...
        <div className="container">
          <div className={styles.grid}>
            ...
            <div className={styles.brand}>
              ...
              <p className={styles.tagline}>Pakistan's leading industrial adhesive manufacturer — trusted by pharma, packaging, and industrial sectors nationwide since 2005.</p>
              ...
              <div className={styles.socials}>
                ...
                <a href="#" className={styles.social} aria-label="WhatsApp">W</a>
              </div>
            </div>
            ...
            <div className={styles.col}>
              ...
              <ul className={styles.colList}>
                <li><Link to="/products">Pharmaceutical Adhesives</Link></li>
                <li><Link to="/products">Industrial Bonding Agents</Link></li>
                <li><Link to="/products">Packaging Glues</Link></li>
                <li><Link to="/products">Hot Melt Adhesives</Link></li>
                <li><Link to="/products">UV-Cure Adhesives</Link></li>
                <li><Link to="/products">Custom Formulations</Link></li>
              </ul>
            </div>
      ...
      <div className={styles.bottom}>
        <div className="container">
          <div className={styles.bottomInner}>
            <p className={styles.copyright}>© 2025 Bizfam Pakistan (Pvt.) Ltd. All rights reserved.</p>
