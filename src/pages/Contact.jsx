    ...
    <main className={styles.main}>
      <section className={styles.header}>
        ...
        <div className="container">
          ...
          <h1 className={styles.title}>Contact <span className={styles.accent}>Bizfam</span></h1>
          <p className={styles.subtitle}>Request a quote, ask for a technical data sheet, or talk to our engineers about a custom formulation.</p>
        </div>
      </section>
          ...
          <div className={styles.grid}>
            <div className={styles.formCol}>
              ...
              {sent ? (
                <div className={styles.success}>
                  ...
                  <button className={styles.resetBtn} onClick={() => setSent(false)}>Send Another Message</button>
                </div>
              ) : (
                <form className={styles.form} onSubmit={submit}>
                  ...
                  <div className={styles.field}>
                    <label>Message *</label>
                    <textarea name="message" value={form.message} onChange={handle} rows={5} placeholder="Describe your application, required volume, specifications, or any questions..." required></textarea>
                  </div>
            ...
            <div className={styles.infoCol}>
              <div className={styles.infoCard}>
                ...
                <div className={styles.infoItem}>
                  ...
                  <div>
                    ...
                    <p>Industrial Zone, S.I.T.E. Area<br />Karachi, Sindh, Pakistan</p>
                  </div>
                </div>
                <div className={styles.infoItem}>
                  <span className={styles.infoIcon}>📞</span>
                ...
                <div className={styles.infoItem}>
                  ...
                  <div>
                    <strong>Email</strong>
                    <p>info@bizfampakistan.com<br />sales@bizfampakistan.com</p>
                  </div>
                </div>
                <div className={styles.infoItem}>
                  <span className={styles.infoIcon}>🕐</span>
              ...
              <div className={styles.quickCard}>
                ...
                <p>For urgent orders or technical support, our team typically responds within 2–4 hours during business hours.</p>
